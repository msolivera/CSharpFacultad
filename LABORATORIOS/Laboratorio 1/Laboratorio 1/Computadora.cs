...
namespace Laboratorio_1
{
    class Computadora
    {
        ...
        public List<DiscoDuro> discos { get; set; }
        public List<MemoriaRAM> mRam { get; set; }
        ...
        public List<SistemaOperativo> sistemasOperativos { get; set; }
        /// <summary>
        ...
        public void instalarSO(SistemaOperativo so)
        {
            ...
            {
                Console.WriteLine("No hay suficiente espacio en el disco para instalar este sistema operativo o no dispone de un disco duro");
